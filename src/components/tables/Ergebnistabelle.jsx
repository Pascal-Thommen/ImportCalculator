            ...
            <tbody>
              {ergebnisse.map((e, i) => (
                <tr key={e.id || i} className={`border-b border-gray-100 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                  ...
                  <td className="px-3 py-2 text-right font-mono text-gray-700">{formatPYG(e.kosten)}</td>
                  <td className="px-3 py-2 text-right font-mono text-gray-700">{formatPYG(e.steuern)}</td>
                  <td className="px-3 py-2 text-right font-mono font-semibold text-gray-800">{formatPYG(e.total)}</td>
                  <td className="px-3 py-2 text-right font-mono text-blue-700 font-semibold">{formatPYG(e.kostenProUnidad)}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
              <tr className="bg-gray-800 text-white">
                ...
                <td className="px-3 py-2 text-right font-mono font-bold">{formatPYG(totalKosten)}</td>
                <td className="px-3 py-2 text-right font-mono font-bold">{formatPYG(totalSteuern)}</td>
                <td className="px-3 py-2 text-right font-mono font-bold">{formatPYG(totalTotal)}</td>
                <td className="px-3 py-2"></td>
              </tr>
            </tfoot>
          </table>
